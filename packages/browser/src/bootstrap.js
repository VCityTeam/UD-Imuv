...
socketIOWrapper.connectToServer('packages/browser').then(() => {
  debugger;
});
...
// webSocketService.on(
//   Constant.WEBSOCKET.MSG_TYPES.SERVER_ALERT,
//   function (message) {
//     alert(message);
//   }
// );
...
// if (paramsUrl.has(Constant.URL_PARAMETER.ID_KEY)) {
//   const id = paramsUrl.has(Constant.URL_PARAMETER.ID_KEY);
//   let event = null;
//   let wrongParams = false;
//   const params = {};

//   switch (id) {
//     case Constant.URL_PARAMETER.EVENT.TELEPORT_AVATAR_WORLD.ID_VALUE:
//       event = Constant.URL_PARAMETER.EVENT.TELEPORT_AVATAR_WORLD;
//       //get params
...
//             function (data) {
//               if (data.role != Constant.USER.ROLE.GUEST) {
...
//             launchGame(Constant.USER.ROLE.GUEST);
//           });
//         } else {
