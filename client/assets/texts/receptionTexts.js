...
const texts = {
  FR: {
    ...
    aboutIsletFigcaption: "Modele 3D de l'Ilôt",
    ...
    aboutAvatarFigcaption: "Modele 3D de l'Avatar",
  ...
  EN: {
    ...
    aboutTitleDescription: 'Description',
    aboutDescription:
      "The Flying Campus project is led by the <b>Labex IMU<b>, it is an immersive collaborative tool in the form of a digital campus in a <b>3D world<b> persisting on the <b>web<b>. The intention of this project is to propose an innovative virtual collaborative space intended primarly for laborattories and for partners of IMU's community. But also, a virtual space staying partly accessible 24h/24h for cyty's actors ; practitioners and citizens interessed by permanent reflections on the urban development in all <b>academic scientific<b> fields.",
